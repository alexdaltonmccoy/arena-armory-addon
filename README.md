...
Shipped voice clips (`Media/Voice/*.ogg`) call out enemy trinkets, CC, major cooldowns (Bubble, Cloak, Ice Block, …), drinking, resurrects, and low health. Optional text-to-speech is available but off by default.
